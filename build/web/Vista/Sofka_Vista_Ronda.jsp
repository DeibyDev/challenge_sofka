            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div id="modal1" class="modal ">
                        ...
                        <div class="modal-footer">
                            <a href="#!" class="modal-close waves-effect waves-green btn-flat blue darken-1 center-align " >Aceptar</a>
...
<script>
    ...
    $(document).ready(function ()
    {
        $("#boton").click(function () {
            ...
            console.log(nombre);
            console.log(premio);
            window.location.href = 'ctr_challenge_sofka?accion=Ronda_3&respuesta=' + respuesta + '&opcion=' +${datos.preg_id} + '&nombre=' + nombre + '&acumulado=' +${datos.ronda.getRond_premio()}
            + '&premio=' + premio;
            return false;
